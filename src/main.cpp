...
const short MQTT_HOST_PORT = 8000;
const char *MQTT_HOST_USERNAME = "Vidumina";
const char *MQTT_HOST_PASSWORD = "123456";
const char *MQTT_CLIENT_ID = "clientId-YFSvM8fCAb";
...
void setup() {
    ...
    if (!LittleFS.exists("/HomeAPCredentials.txt")) {
        ...
        WiFi.begin("HUAWEI GR5 2017", "RMVC@982583152");
        ...
        Serial.println("HUAWEI GR5 2017");
        ...
        while (true) {
            ...
            /*mqttClient.publish("readings", 0, true, "[{\"RV\":0.123,\"RI\":0.345,\"time\":1674890175442},{\"RV\":0.456,\"RI\":0.456,\"time\":1674890175442},{\"RV\":0.123,\"RI\":0.345,\"time\":1674890175442},{\"RV\":0.789,\"RI\":0.567,\"time\":1674890175442}]");
            delay(10000);*/
            mqttClient.publish("readings", 0, true, "doc");
            delay(10000);
